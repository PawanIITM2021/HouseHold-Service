            ...
            <div class="row  justify-content-left">
                <div class="col-lg-3 mt-3  " style="border-collapse: collapse;"  v-for="(section,i) in sections" :key="i">
                    <div class="card border-success">
                     <div class="card-header text-success">
                               <div class="clearfix">
                                    ...
                                    <div class="float-end">
                                         <button class="btn btn-warning btn-sm" v-if="role=='admin'" @click="editSection(section.section_id)">Edit</button>
                                         <button class="btn btn-danger btn-sm" v-if="role=='admin'" @click="deleteEdit(section.section_id)">Delete</button>
                    ...
                    <div class="card-body fs-regular">
                           About :  {{section.section_discription}}
                    </div>
                    </div>         
                </div>   
            </div>
...
<!-- Modal -->
         <div class="modal fade" id="addNewServiceModal" tabindex="-1" aria-labelledby="addNewServiceModalLabel" aria-hidden="true">
           <div class="modal-dialog modal-lg">
             <div class="modal-content">
               <div class="modal-header">
                 <h1 class="modal-title fs-5" id="addNewServiceModalLabel">Add New Section</h1>
                 ...
                 <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control"  v-model="new_section.section_discription"></textarea>
                        </div>
                    </div>
                 </div>
               </div>
           ...
           <div class="modal-dialog modal-lg">
             <div class="modal-content">
               <div class="modal-header">
                 <h1 class="modal-title fs-5" id="editServiceModalLabel">Edit Section</h1>
                 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
               </div>
               <div class="modal-body">
                 <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-label">Section Discription</label>
                            <textarea class="form-control" rows="5"  v-model="edit_section.section_discription"></textarea>
                        </div>
                    </div>
                 </div>
               </div>
